...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <asp:FormView ID="frwNovoDoc" RenderOuterTable="false" runat="server" OnItemInserted="frwNovoDoc_ItemInserted" DataKeyNames="cod_fin" DataSourceID="sqlNovoDoc" DefaultMode="Insert">
        <InsertItemTemplate>
