...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <div class="row">
        <div class="span4">
            <a class="btn btn-inverse" href="FinTipoBaixaAdicionar.aspx"><i class="icon-plus icon-white"></i> Cadastrar Tipo Baixa</a>
        </div>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style="vertical-align: middle; text-align: center;">
                    <a class="btn btn-inverse" href="FinTipoBaixaDetalhes.aspx?p=<%# Eval("cod_tipo") %>">Mais Detalhes</a>
                </td>
            </tr>
        </ItemTemplate>
        <LayoutTemplate>
            <table id="itemPlaceholderContainer" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr id="Tr1" runat="server">
                       <th style="width: 80%">Tipo Baixa</th>
