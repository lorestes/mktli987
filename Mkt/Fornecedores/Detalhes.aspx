<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Detalhes.aspx.cs" Inherits="Mkt.Fornecedores.Detalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <asp:SqlDataSource ID="sqlFornecedor" runat="server" ConnectionString="<%$ ConnectionStrings:marketingdbConnectionString %>" 
        ...
        <UpdateParameters>
            ...
            <asp:ControlParameter ControlID="ctl00$contentPlaceHolder$frwNovoFornecedor$cidadesDDL" Name="cod_cidade" Type="Int32" />
