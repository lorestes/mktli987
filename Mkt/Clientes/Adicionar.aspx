<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Adicionar.aspx.cs" Inherits="Mkt.Clientes.Adicionar" %>
<asp:Content ID="headContent" ContentPlaceHolderID="headPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="boydContent" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <asp:FormView ID="frwNovoCliente" RenderOuterTable="false" runat="server" DataKeyNames="cod_pessoa" OnItemInserted="frwNovoCliente_ItemInserted" DataSourceID="sqlNovoCliente" DefaultMode="Insert">
        <InsertItemTemplate>
    ...
    <asp:SqlDataSource ID="sqlNovoCliente" runat="server" ConnectionString="<%$ ConnectionStrings:marketingdbConnectionString %>" 
