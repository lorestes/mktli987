...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    ...
    <asp:FormView ID="frwNovoHistorico" RenderOuterTable="false" runat="server" OnItemInserted="frwNovoHistorico_ItemInserted" DataKeyNames="cod_hist" DataSourceID="sqlNovoHistorico" DefaultMode="Insert">
        <InsertItemTemplate>
